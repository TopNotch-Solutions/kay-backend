...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('specialized_inpatient_daily_records', {
    ...
    await queryInterface.addIndex('specialized_inpatient_daily_records', ['admission_id', 'record_date'], {
      unique: true,
      name: 'si_daily_records_admission_date_unique',
    });
  },

  async down(queryInterface) {
    await queryInterface.dropTable('specialized_inpatient_daily_records');
  },
};
