...
/** Adds front_office_supervisor role and permissions for existing databases. */
module.exports = {
  async up(queryInterface) {
    const roleName = ROLES.FRONT_OFFICE_SUPERVISOR;
    ...
    await queryInterface.bulkInsert('roles', [{
      name: roleName,
      display_name: 'Front Office Supervisor',
    }]);
